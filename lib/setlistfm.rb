...
# 
#
# Generated by <a href="https://enunciate.codehaus.org">Enunciate</a>.
#
require 'json'
...
module Model
  ...
  # href="https://geonames.org/">Geonames.org</a>.
  class City 
    ...
    # href=&quot;https://download.geonames.org/export/dump/admin1Codes.txt&quot;&gt;a
...
module Model
  ...
  class Country 
    ...
    attr_accessor :name
    # The country's &lt;a
    # href=&quot;https://www.iso.org/iso/english_country_names_and_code_elements&quot;
...
module Model
  ...
  # as defined in the <a href="https://www.setlist.fm/guidelines">Guidelines</a>
  # or encores.
  class Set 
...
module Model
  ...
  # <a href="https://www.setlist.fm/">setlist.fm</a> works the wiki way, there can
  ...
  class Setlist 
    ...
    # the setlist's tour
    attr_accessor :tour
    # the id this event has on &lt;a href=&quot;https://last.fm/&quot;&gt;last.fm&lt;/a&gt;
    ...
    # href=&quot;https://www.setlist.fm/guidelines&quot;&gt;setlist.fm guidelines&lt;/a&gt;
    ...
    def init_jaxb_json_hash(_o)
      ...
      if !_o['sets'].nil?
        @sets = Array.new
        _oa = _o['sets']
        _oa.each { | _item | @sets.push Fm::Setlist::Api::Model::Set.from_json(_item) }
      end
...
module Model
  ...
  class Song 
    ...
    # href=&quot;https://www.setlist.fm/guidelines&quot;&gt;setlist.fm guidelines&lt;/a&gt; for a
...
module Model
  ...
  # href="https://wiki.musicbrainz.org/MBID">Musicbrainz Identifier</a> (MBID)
